...
export default function Sidebar() {
  ...
  return (
    <aside className={`p-5 max-w-80 duration-300 ${collapsed ? "transform -translate-x-full" : "transform translate-x-0"} shadow-2xl absolute md:static z-50 bg-white border-r border-gray-300 min-h-full`}>
